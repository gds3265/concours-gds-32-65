...
v0.8.0 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.8.0 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.8.0 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.8.0 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.8.0 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.8.0 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.8.0 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.8.0 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.8.0 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.8.0 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.8.0 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.8.0 — CONTRÔLE À L'ENTRÉE DU CONCOURS
...
NOUVEAUTÉS v0.8.0 — AFFICHAGE GLOBAL PAR DÉFAUT
...
NOUVEAUTÉS v0.8.0 — LISIBILITÉ PAR CHEPTEL + LISTES DE CONTRÔLE
...
NOUVEAUTÉS v0.8.0 — RENOUVELLEMENT AUTOMATIQUE DE SESSION SUPABASE
...
NOUVEAUTÉS v0.8.0 — ANALYSES + ZOOM FIN
...
NOUVEAUTÉS v0.8.0 — CORRECTION CHARGEMENT CERTIFICATS
...
NOUVEAUTÉS v0.8.0 — FORÇAGE MISE À JOUR / ANTI-CACHE
...
NOUVEAUTÉS v0.8.0 — CORRECTION DÉMARRAGE COMPLET
