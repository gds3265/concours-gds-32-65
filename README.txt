...
v0.7.0 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.7.0 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.7.0 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.7.0 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.7.0 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.0 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.0 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.7.0 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.7.0 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.7.0 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.7.0 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.7.0 — CONTRÔLE À L'ENTRÉE DU CONCOURS
