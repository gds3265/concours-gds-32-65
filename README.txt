...
v0.7.4 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.7.4 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.7.4 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.7.4 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.7.4 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.4 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.4 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.7.4 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.7.4 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.7.4 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.7.4 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.7.4 — CONTRÔLE À L'ENTRÉE DU CONCOURS
...
NOUVEAUTÉS v0.7.4 — AFFICHAGE GLOBAL PAR DÉFAUT
