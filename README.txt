...
v0.9.4 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.9.4 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.9.4 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.9.4 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.9.4 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.9.4 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.9.4 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.9.4 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.9.4 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.9.4 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.9.4 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.9.4 — CONTRÔLE À L'ENTRÉE DU CONCOURS
...
NOUVEAUTÉS v0.9.4 — AFFICHAGE GLOBAL PAR DÉFAUT
...
NOUVEAUTÉS v0.9.4 — LISIBILITÉ PAR CHEPTEL + LISTES DE CONTRÔLE
...
NOUVEAUTÉS v0.9.4 — RENOUVELLEMENT AUTOMATIQUE DE SESSION SUPABASE
...
NOUVEAUTÉS v0.9.4 — RETOUR STRICT À LA BASE FONCTIONNELLE
...
NOUVEAUTÉS v0.9.4 — CERTIFICATS SIMPLIFIÉS
...
NOUVEAUTÉS v0.9.4 — RECHERCHE REMBOURSEMENTS
...
NOUVEAUTÉS v0.9.4 — EXPORTS DE RELAIS
...
NOUVEAUTÉS v0.9.4 — MÉTHODES PRIORITAIRES + ÂGE
...
NOUVEAUTÉS v0.9.4 — EXPORTS PLUS VISUELS
...
NOUVEAUTÉS v0.9.4 — QUALIFICATIONS + ANIMAUX SUR LE MÊME SUPPORT
...
NOUVEAUTÉS v0.9.4 — VERSION DE RÉPARATION
...
NOUVEAUTÉS v0.9.4 — CONCOURS CLOS + TUILES EXPORT NETTOYÉES
...
NOUVEAUTÉS v0.9.4 — CORRECTION DATE VIDE ANALYSES
...
NOUVEAUTÉS v0.9.4 — MÉTHODE D'ANALYSE + CONFORME NON REMBOURSABLE
- Correction du changement de méthode d'analyse : l'ancienne méthode ne reprend plus la main après rechargement.
- La méthode prioritaire reste marquée ★.
- Les méthodes recevables mais non prioritaires restent sélectionnables.
- Nouveau statut : "Conforme — Ag suffisait / non remboursable" pour la BVD.
- Ce statut compte comme conforme pour le sanitaire, le certificat et le tableau de bord.
- Ce statut est automatiquement exclu du remboursement.
- Une PCR BVD conforme peut donc valider le bovin tout en restant non éligible si l'Ag de référence suffisait.
- PDF/Excel : "Conforme — non remboursable" reste affiché en vert car le sanitaire est conforme.
- Aucun SQL supplémentaire.
