...
v0.5.7 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.5.7 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.5.7 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.5.7 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.5.7 — CORRECTION IMPORT QUALIFICATIONS
