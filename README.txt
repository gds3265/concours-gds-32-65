...
v0.8.2 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.8.2 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.8.2 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.8.2 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.8.2 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.8.2 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.8.2 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.8.2 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.8.2 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.8.2 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.8.2 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.8.2 — CONTRÔLE À L'ENTRÉE DU CONCOURS
...
NOUVEAUTÉS v0.8.2 — AFFICHAGE GLOBAL PAR DÉFAUT
...
NOUVEAUTÉS v0.8.2 — LISIBILITÉ PAR CHEPTEL + LISTES DE CONTRÔLE
...
NOUVEAUTÉS v0.8.2 — RENOUVELLEMENT AUTOMATIQUE DE SESSION SUPABASE
...
NOUVEAUTÉS v0.8.2 — RECONSTRUCTION SUR BASE STABLE
- Reconstruction depuis v0.7.6 pour récupérer la navigation et la persistance de session stables.
- certRecapSort, fastCurrentHerd et fastCurrentFarmer initialisés avant loadAll().
- Suppression de la date globale dans Analyses.
- Les changements de statut ne modifient plus les dates déjà enregistrées.
- Zoom fin appliqué uniquement au contenu principal, jamais à la barre de navigation.
- Navigation d'origine conservée.
- Le refresh token est conservé afin que F5 puisse maintenir la connexion.
- Marqueur visible 082.
- Aucun SQL supplémentaire.
