...
v0.5.5 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.5.5 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.5.5 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.5.5 — QUALIFICATIONS EN MASSE
