...
v0.7.9 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.7.9 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.7.9 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.7.9 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.7.9 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.9 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.9 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.7.9 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.7.9 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.7.9 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.7.9 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.7.9 — CONTRÔLE À L'ENTRÉE DU CONCOURS
...
NOUVEAUTÉS v0.7.9 — AFFICHAGE GLOBAL PAR DÉFAUT
...
NOUVEAUTÉS v0.7.9 — LISIBILITÉ PAR CHEPTEL + LISTES DE CONTRÔLE
...
NOUVEAUTÉS v0.7.9 — RENOUVELLEMENT AUTOMATIQUE DE SESSION SUPABASE
...
NOUVEAUTÉS v0.7.9 — ANALYSES + ZOOM FIN
...
NOUVEAUTÉS v0.7.9 — CORRECTION CHARGEMENT CERTIFICATS
...
NOUVEAUTÉS v0.7.9 — FORÇAGE MISE À JOUR / ANTI-CACHE
