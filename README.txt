...
v0.7.2 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.7.2 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.7.2 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.7.2 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.7.2 — CORRECTION IMPORT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.2 — CORRECTION RAPPROCHEMENT QUALIFICATIONS
...
NOUVEAUTÉS v0.7.2 — CORRECTION FICHIERS QUALIFICATIONS EXCEL
...
NOUVEAUTÉS v0.7.2 — SUIVI GESTIONNAIRE DES PARTENAIRES
...
NOUVEAUTÉS v0.7.2 — PARTENAIRES UTILISABLES DE BOUT EN BOUT
...
NOUVEAUTÉS v0.7.2 — PORTAIL PARTENAIRE : 2 MODES DISTINCTS
...
NOUVEAUTÉS v0.7.2 — FINALISATION PORTAIL PARTENAIRE
...
NOUVEAUTÉS v0.7.2 — CONTRÔLE À L'ENTRÉE DU CONCOURS
