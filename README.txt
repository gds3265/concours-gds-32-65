...
v0.5.6 : espace partenaires, accès par concours, vérification facultative et validation finale simplifiée.

NOUVEAUTÉS v0.5.6 — MODE PARTENAIRE AUTOMATIQUE
...
NOUVEAUTÉS v0.5.6 — IMPORT CSV INTELLIGENT
...
NOUVEAUTÉS v0.5.6 — QUALIFICATIONS EN MASSE
...
NOUVEAUTÉS v0.5.6 — CORRECTION IMPORT QUALIFICATIONS
